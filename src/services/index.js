...
const createCampaignForGivethioProjects = require('./createCampaignForGivethioProjects/createCampaignForGivethioProjects.service');
...
module.exports = function configure() {
  ...
  app.configure(createCampaignForGivethioProjects);
};
