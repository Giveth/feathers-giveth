 ...
 *
 * @param {string|array} props property or array of properties we should attempt to resolve ipfs file paths for
...
module.exports = (props, resolveInternal = false) => context => {
  ...
  checkContext(context, 'after', ['find', 'create', 'update', 'patch']);
